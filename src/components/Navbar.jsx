...
export default function Navbar(props) {
  return (
    ...
    <label className="form-check-label mx-4" htmlFor="flexSwitchCheckDefault"> Violet </label>
    </div>

    {/*Green mode*/}
    <div className={`form-check form-switch text-${props.mode==="light"?"dark":"light"}`}>
    <input className="form-check-input" onClick={props.toggleMode2} type="checkbox" role="switch" id="flexSwitchCheckDefault"/>
    <label className="form-check-label mx-4" htmlFor="flexSwitchCheckDefault"> Nature </label>
    </div>

    {/*Blue mode*/}
    <div className={`form-check form-switch text-${props.mode==="light"?"dark":"light"}`}>
    <input className="form-check-input" onClick={props.toggleMode1} type="checkbox" role="switch" id="flexSwitchCheckDefault"/>
    <label className="form-check-label mx-4" htmlFor="flexSwitchCheckDefault"> Dark </label>
    </div>
  </nav> 
  );
}
...
//                       aboutText : 'Write information here'
//}